...
DEFAULT_LINE_COLOR = QColor(0, 0, 255, 0)
DEFAULT_FILL_COLOR = QColor(255, 0, 255, 0)
DEFAULT_SELECT_LINE_COLOR = QColor(255, 0, 0)
DEFAULT_SELECT_FILL_COLOR = QColor(0, 0, 0, 0)
DEFAULT_VERTEX_FILL_COLOR = QColor(255, 255, 0, 100)
DEFAULT_HVERTEX_FILL_COLOR = QColor(255, 255, 0)
DEFAULT_HVERTEX_FILL_COLOR = QColor(255, 255, 0, 0)
    ...
    def paint(self, painter):
        if self.points:
            ...
            if self.label is not None :
                ...
                top_left_point = QPointF(self.points[0].x(),self.points[0].y()-int(10*1.15))
